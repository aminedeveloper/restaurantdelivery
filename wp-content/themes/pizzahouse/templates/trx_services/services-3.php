...
if ( !function_exists( 'pizzahouse_template_services_3_theme_setup' ) ) {
	add_action( 'pizzahouse_action_before_init_theme', 'pizzahouse_template_services_3_theme_setup', 1 );
	function pizzahouse_template_services_3_theme_setup() {
		pizzahouse_add_template(array(
			'layout' => 'services-3',
			'template' => 'services-3',
			'mode'   => 'services',
			'need_columns' => true,
			'title'  => esc_html__('Services /Style 3/', 'pizzahouse'),
...
// Template output
if ( !function_exists( 'pizzahouse_template_services_3_output' ) ) {
	function pizzahouse_template_services_3_output($post_options, $post_data) {
