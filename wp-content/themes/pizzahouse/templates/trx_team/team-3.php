...
if ( !function_exists( 'pizzahouse_template_team_3_theme_setup' ) ) {
	add_action( 'pizzahouse_action_before_init_theme', 'pizzahouse_template_team_3_theme_setup', 1 );
	function pizzahouse_template_team_3_theme_setup() {
		pizzahouse_add_template(array(
			'layout' => 'team-3',
			'template' => 'team-3',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 3/', 'pizzahouse'),
...
// Template output
if ( !function_exists( 'pizzahouse_template_team_3_output' ) ) {
	function pizzahouse_template_team_3_output($post_options, $post_data) {
		$show_title = true;
