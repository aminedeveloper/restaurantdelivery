...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by pizzahouse
	 * @var $inverse	- added by pizzahouse
	 * @var $style_line	- added by pizzahouse
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by pizzahouse:
	// Color scheme
	if ($scheme && !pizzahouse_param_is_off($scheme) && !pizzahouse_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !pizzahouse_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	// Line style
	if ($style_line && !pizzahouse_param_is_off($style_line)) $css_classes[] = 'style_line';
	...
	// Add pizzahouse color scheme in the row
	if ($scheme && !pizzahouse_param_is_off($scheme) && !pizzahouse_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
