...
// Shortcode template
if ( ! class_exists( 'PIZZAHOUSE_VC_ShortCode' ) ) {
	abstract class PIZZAHOUSE_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'Pizzahouse_VC_ShortCodeSingle' ) ) {
	abstract class Pizzahouse_VC_ShortCodeSingle extends PIZZAHOUSE_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'Pizzahouse_VC_ShortCodeAlone' ) ) {
	abstract class Pizzahouse_VC_ShortCodeAlone extends PIZZAHOUSE_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'PIZZAHOUSE_VC_ShortCodeContainer' ) ) {
	abstract class PIZZAHOUSE_VC_ShortCodeContainer extends PIZZAHOUSE_VC_ShortCode {
...
if ( ! class_exists( 'PIZZAHOUSE_VC_ShortCodeCollection' ) ) {
	abstract class PIZZAHOUSE_VC_ShortCodeCollection extends PIZZAHOUSE_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'PIZZAHOUSE_VC_ShortCodeItem' ) ) {
	abstract class PIZZAHOUSE_VC_ShortCodeItem extends PIZZAHOUSE_VC_ShortCode {
...
if ( ! class_exists( 'PIZZAHOUSE_VC_ShortCodeColumns' ) ) {
	abstract class PIZZAHOUSE_VC_ShortCodeColumns extends PIZZAHOUSE_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('PIZZAHOUSE_VC_ShortCodeAccordion') ) {
	abstract class PIZZAHOUSE_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class PIZZAHOUSE_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('PIZZAHOUSE_VC_ShortCodeToggles') ) {
	abstract class PIZZAHOUSE_VC_ShortCodeToggles extends PIZZAHOUSE_VC_ShortCodeAccordion {}
	abstract class PIZZAHOUSE_VC_ShortCodeTogglesItem extends PIZZAHOUSE_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'PIZZAHOUSE_VC_ShortCodeTabs' ) ) {
	abstract class PIZZAHOUSE_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class PIZZAHOUSE_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
