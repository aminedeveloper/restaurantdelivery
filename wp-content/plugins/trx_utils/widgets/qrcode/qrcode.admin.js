...
jQuery(document).ready(function(){
	pizzahouse_qrcode_init();
	pizzahouse_color_picker();
});

function pizzahouse_qrcode_init() {
...
function pizzahouse_qrcode_update(widget) {
	pizzahouse_qrcode_show(widget, {
...
function pizzahouse_qrcode_show(widget, vc, opt) {
	if (opt.show_what==1) {
...
if (!window.pizzahouse_set_color_picker) {
	function pizzahouse_set_color_picker(id_picker) {
